  ...
  return (
    <div className="list" data-aos="zoom-in-right" data-aos-duration="2000">
      ...
      <div className="list__mainDiv">
        {link ?<a className="list__link" href={link} target="_blank">{link}</a> : <span className="project_list__link">No Link available you can go to sctors to show more Detial </span>}
      </div>
    </div>
  );
}
